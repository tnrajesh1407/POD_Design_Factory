...
def _collect_preview_images(job_id: str):
    ...
    for i in range(1, 500):  # safe upper bound
        ...
        for fname in ("01_original.png", "05_mockup.png"):
...
def _run_pipeline(job_id: str, prompt: str, num_designs: int):
    ...
    try:
        ...
        for i in range(1, num_designs + 1):
            ...
            mockup = f"{design_dir}/05_mockup.png"
            ...
            #generate_image(prompt, original)
            ...
            # 5 Print-ready canvas
            place_on_pod_canvas(transparent, print_ready)
            bump("print_ready", f"Variation {i}: print-ready created")

            # 6 Mockup
            create_mockup(print_ready, mockup)
            #create_mockup(transparent, mockup)
            bump("mockup", f"Variation {i}: mockup created")

            # 7 SEO
            seo = generate_seo_metadata(print_ready)
